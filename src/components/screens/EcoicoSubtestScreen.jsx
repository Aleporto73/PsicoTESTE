...
import { useEcoicoLogic, ECOICO_EXAMPLES } from '../../hooks/useEcoicoLogic';
import { ECOICO_STRUCTURE } from '../../data/ecoico';
...
export default function EcoicoSubtestScreen({
    ...
    } = useEcoicoLogic(sessionInfo, isReadOnly);
                ...
                <div className="header-actions">
                    ...
                    {!isReadOnly && (
                        <button
                            ...
                            onClick={() => handleFinalizeSubtest(onFinalize)}
